# Stub async Gemini chat function for agent integration
import asyncio

async def chat_with_gemini(prompt: str) -> str:
    """
    Simulate a Gemini LLM call. Replace with real Gemini API integration.
    """
    await asyncio.sleep(0.1)  # Simulate network/processing delay
    return '{"tool": "fetch_net_worth", "args": {"session_id": "demo-session"}}'  # Dummy response
import vertexai
